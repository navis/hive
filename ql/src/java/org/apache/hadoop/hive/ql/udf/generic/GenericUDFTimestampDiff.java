...
public class GenericUDFTimestampDiff extends GenericUDF {
  ...
  private transient HiveIntervalDayTimeObjectInspector inputOI;
  ...
  public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException {
    ...
    switch (((PrimitiveObjectInspector)arguments[1]).getPrimitiveCategory()) {
      ...
      case INTERVAL_DAY_TIME:
        inputOI = (HiveIntervalDayTimeObjectInspector)arguments[1];
        break;
      default:
        throw new UDFArgumentException(
    ...
    try {
      ...
      throw new UDFArgumentException(
          "The function TIMESTAMPDIFF takes only interval type");
    }
  ...
  public Object evaluate(DeferredObject[] arguments) throws HiveException {
    ...
    long totalSeconds;
    if (converter != null) {
      totalSeconds = (Long)converter.convert(o0);
    } else {
      totalSeconds = inputOI.getPrimitiveJavaObject(o0).getTotalSeconds();
    }
    switch (type) {
