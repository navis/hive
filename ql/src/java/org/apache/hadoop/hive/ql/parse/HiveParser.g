...
@after { popMsg(state); }
    ...
    | KW_SHOW KW_TABLES ((KW_FROM|KW_IN) db_name=identifier)? (KW_LIKE showStmtIdentifier|showStmtIdentifier)? KW_STATISTICS?
    -> ^(TOK_SHOWTABLES (TOK_FROM $db_name)? showStmtIdentifier? KW_STATISTICS?)
